...
var CardWidget = /*#__PURE__*/function () {
  ...
  _createClass(CardWidget, [{
    ...
    value: function mount() {
      ...
      var elements = this.stripe.elements(); // create 1st parameter is type of payment to integrate = 'card' in our case
      ...
      this.card.mount('#card-element'); // mount this element in browser
...
/* harmony import */ var _apiService__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./apiService */ "./resources/js/apiService.js");
/* harmony import */ var _CardWidget__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./CardWidget */ "./resources/js/CardWidget.js");
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_3__.loadStripe)('pk_test_51L996nSAv2MZQ1DpkBXDppPPGZvOGudPgL9ti1MAlzghp60KiG5P8Wyv1fF6yWb3cG2foidWZleKJzb9znuzl1Tq003IrzHgnX');
          ...
          case 2:
            ...
            card = null; // stores the card element to be shown at cart page
            ...
            paymentType = document.querySelector('#paymentType'); // this is done to avoid adding event listner when we are not on cart page -> then we will get error in console -> addEvent Listner to null
          ...
          case 7:
            ...
            paymentType.addEventListener('change', function (e) {
              ...
              if (e.target.value === 'card') {
                ...
                // mountWidget();
                card = new _CardWidget__WEBPACK_IMPORTED_MODULE_5__.CardWidget(stripe);
                card.mount();
              } else {
                    ...
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          ...
                          e.preventDefault(); // console.log(e); // using this, when you click order now, you can see submit event in console of browser
                          // get form data here

                          formData = new FormData(paymentForm); // object of form data in js(FormData is in built class in js)
                          ...
                          formObject = {}; // empty object to store above object
                          ...
                          // AJAX
                          (0,_apiService__WEBPACK_IMPORTED_MODULE_4__.placeOrder)(formObject); // console.log(formObject)
                        ...
                        case 10:
                          ...
                          formObject.stripeToken = token.id;
                          (0,_apiService__WEBPACK_IMPORTED_MODULE_4__.placeOrder)(formObject);
